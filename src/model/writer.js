 ...
 * * supports unicode, see {@link engine.model.Text} for more information.
 *
...
function _splitNodeAtPosition( position ) {
	...
	if ( textNode ) {
		...
		const firstPart = new Text( textNode.getSymbols( 0, offsetDiff ), textNode.getAttributes() );
		const secondPart = new Text( textNode.getSymbols( offsetDiff, textNode.offsetSize - offsetDiff ), textNode.getAttributes() );
