...
export default class SplitOperation extends Operation {
	...
	constructor( splitPosition, howMany, insertionPosition, graveyardPosition, baseVersion ) {
		 ...
		 */
		this.insertionPosition = Position.createFromPosition( insertionPosition );
	...
	get moveTargetPosition() {
		...
		let pos = new Position( this.insertionPosition.root, path );
	...
	_execute() {
		...
		const sourceRange = Range.createFromParentsAndOffsets( splitElement, this.splitPosition.offset, splitElement, splitElement.maxOffset );
