...
describe( 'move', () => {
	...
	it( 'should support unicode', () => {
		...
		modelWriter.move(
			ModelRange.createFromParentsAndOffsets( modelDivA, 1, modelDivA, 3 ),
			ModelPosition.createAt( modelDivB, 'end' )
		);

		dispatcher.convertMove(
			ModelPosition.createFromParentAndOffset( modelDivA, 1 ),
			ModelRange.createFromParentsAndOffsets( modelDivB, 0, modelDivB, 2 )
		);
...
describe( 'remove', () => {
	...
	it( 'should support unicode', () => {
		...
		modelWriter.move(
			ModelRange.createFromParentsAndOffsets( modelDiv, 0, modelDiv, 3 ),
